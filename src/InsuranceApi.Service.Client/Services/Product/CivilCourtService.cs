...
{
    internal class CivilCourtService(ILogWriter logWriter, IHttpClientFactory httpClientFactory, IOptions<ApiConfig> option) : ICivilCourtService
    {
        ...
        public async Task<IEnumerable<CivilCourtModel>?> GetAllAsync()
        {
            ...
            try
            {
                ...
                rawRequest.RequestUri = $"{_endpont.Url}/v1/civilCourt/get-all";
                
                rawResponse = await _httpClient.GetAsync<RawRequest, RawResponse>(rawRequest.RequestUri, rawRequest);
                var response = JsonConvert.DeserializeObject<BaseDataResponseModel<IEnumerable<CivilCourtModel>>>(rawResponse.Conteudo);
        ...
        public async Task<IEnumerable<CivilCourtModel>?> ListAsync(CivilCourtFilterModel filter)
        {
            ...
            try
            {
                ...
                rawRequest.RequestUri = $"{_endpont.Url}/v1/civilCourt/get-search-civil-court";
